...
BEGIN Facility
    ...
    Name		 Yakima_Training_Center

    BEGIN CentroidPosition

        CentralBody		 Earth
        DisplayCoords		 Geodetic
        EcfLatitude		 4.6682090000000002e+01
        EcfLongitude		 -1.2035654400000000e+02
        EcfAltitude		 5.9300000000000000e+02
        HeightAboveGround		 0.0000000000000000e+00
        ComputeTrnMaskAsNeeded		 Off
        AzElMask		 AzElMaskFile: Yakima_Training_Center.aem
...
Type:           GroundStation
Notes:          
Sources:                       http://en.wikipedia.org/wiki/Yakima_Training_Center
               http://en.wikipedia.org/wiki/ECHELON#Ground_stations
