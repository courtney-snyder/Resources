...
BEGIN Facility
    ...
    Name		 EchoStar_Spokane_Station

    BEGIN CentroidPosition

        CentralBody		 Earth
        DisplayCoords		 Geodetic
        EcfLatitude		 4.7591999999999999e+01
        EcfLongitude		 -1.1755100000000000e+02
        EcfAltitude		 7.2500000000000000e+02
        HeightAboveGround		 0.0000000000000000e+00
        ComputeTrnMaskAsNeeded		 Off
        AzElMask		 AzElMaskFile: EchoStar_Spokane_Station.aem
    ...
    BEGIN Extensions
        ...
        BEGIN Desc
            BEGIN ShortText
EchoStar Spokane Station
Name:           EchoStar Spokane Station
Country:        UnitedStates
Location:       Spokane, Washington
Status:         Active
Type:           GroundStation
Notes:          
Sources:                       http://www.uplinkstation.com/df/Echostar-Uplink-Spokane.html
