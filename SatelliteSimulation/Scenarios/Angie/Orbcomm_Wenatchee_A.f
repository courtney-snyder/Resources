...
BEGIN Facility
    ...
    Name		 Orbcomm_Wenatchee_A

    BEGIN CentroidPosition

        CentralBody		 Earth
        DisplayCoords		 Geodetic
        EcfLatitude		 4.7551684999999999e+01
        EcfLongitude		 -1.2017509000000001e+02
        EcfAltitude		 1.1460000000000000e+03
        HeightAboveGround		 0.0000000000000000e+00
        ComputeTrnMaskAsNeeded		 Off
        AzElMask		 AzElMaskFile: Orbcomm_Wenatchee_A.aem
    ...
    BEGIN Extensions
        ...
        BEGIN Desc
            BEGIN ShortText
Orbcomm Wenatchee A
Name:           Orbcomm Wenatchee A
Country:        UnitedStates
Location:       Wenatchee, Washington
Status:         Active
Type:           GroundStation
Notes:          A GES (Gateway Earth Station) of Orbcomm.
Sources:                       http://www.orbcomm.com/Collateral/Documents/English-US/GES.txt
