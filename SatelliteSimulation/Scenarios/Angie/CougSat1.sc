...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jun 2019 20:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jun 2019 20:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jun 2019 20:00:00.000000000
        Stop		 31 May 2020 20:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jun 2019 20:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -4.1904e+07
            LaunchWindowStop		 -7.33536e+07
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 1 Feb 2018 20:00:00.000000000
                    Stop		 2 Feb 2018 20:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jun 2019 20:00:00.000000000
                EndTime		 31 May 2020 20:00:00.000000000
                CurrentTime		 1 Jun 2019 20:00:00.000000000
                Direction		 Forward
                UpdateDelta		 60
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/Brewster_Station
            Facility/Brewster_Station		
        END Instance
        Instance Facility/EchoStar_Spokane_Station
            Facility/EchoStar_Spokane_Station		
        END Instance
        Instance Facility/Orbcomm_Wenatchee_A
            Facility/Orbcomm_Wenatchee_A		
        END Instance
        Instance Facility/Orbcomm_Wenatchee_B
            Facility/Orbcomm_Wenatchee_B		
        END Instance
        Instance Facility/Pullman_Station
            Facility/Pullman_Station		
        END Instance
        Instance Facility/VLBA_Brewster
            Facility/VLBA_Brewster		
        END Instance
        Instance Facility/Yakima_Training_Center
            Facility/Yakima_Training_Center		
        END Instance
        Instance Place/Pullman
            Place/Pullman		
        END Instance
        Instance Satellite/CougSat
            *		
            Satellite/CougSat		
            Satellite/CougSat/Sensor/Sensor4		
            Satellite/CougSat/Transmitter/Transmitter1		
        END Instance
        Instance Satellite/CougSat/Sensor/Sensor4
            Satellite/CougSat/Sensor/Sensor4		
        END Instance
        Instance Satellite/CougSat/Transmitter/Transmitter1
            Satellite/CougSat/Transmitter/Transmitter1		
        END Instance
    END References
