...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jan 2019 20:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jan 2019 20:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jan 2019 20:00:00.000000000
        Stop		 1 Jan 2020 20:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jan 2019 20:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -2.85984e+07
            LaunchWindowStop		 -6.0048e+07
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 4 Feb 2018 20:00:00.000000000
                    Stop		 5 Feb 2018 20:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            BEGIN LongText
Testing different ground station locations in Washington state. Preferably eastern Washington (Spokane, Tri Cities, Pullman, etc.) or possibly Moscow, ID.
            END LongText
        END Desc
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jan 2019 20:00:00.000000000
                EndTime		 1 Jan 2020 20:00:00.000000000
                CurrentTime		 1 Jan 2019 20:00:00.000000000
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 46.63728835256767
                        CenterLongitude		 -117.6482883455198
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 46.63728835256767
                                CenterLon		 -117.6482883455198
                                ZoomWidth		 5.321117858916458
                                ZoomHeight		 2.650705007497278
                            END ZoomLocation
                        END ZoomLocations
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/WSU
            Facility/WSU		
        END Instance
        Instance Facility/WSU-Spokane
            Facility/WSU-Spokane		
        END Instance
        Instance Facility/WSU-TriCities
            Facility/WSU-TriCities		
        END Instance
